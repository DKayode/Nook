...
export function TransactionRow({ id, merchant, category, amountCents, currency, postedAt, categories }: Props) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 border-b border-border px-5 py-3 last:border-b-0">
      ...
      <div className="flex flex-col items-end gap-1.5">
        <span className={negative ? "font-medium text-ink" : "font-medium text-accent"}>
